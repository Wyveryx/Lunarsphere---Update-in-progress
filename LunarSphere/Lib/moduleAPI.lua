...
--		end
	...
	for i = 1, totalSpells do
		...
		local scanName = spellInfo.name
		local scanRank = spellInfo.subName
	
		-- Get the spell texture
		local scanTexture = string.lower(spellInfo.iconID and select(3, GetSpellTexture(spellInfo.iconID)) or "")
